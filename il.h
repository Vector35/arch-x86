...
struct DISASSEMBLY_OPTIONS
{
	...
	DISASSEMBLY_OPTIONS(DISASSEMBLY_FLAVOR_ENUM df = DF_BN_INTEL, bool lowerCase = true,
	    std::string separator = ", ") :
	    df(df),
	    lowerCase(lowerCase), separator(separator) {};
};
...
bool GetLowLevelILForInstruction(BinaryNinja::Architecture* arch, const uint64_t addr,
    BinaryNinja::LowLevelILFunction& il, const xed_decoded_inst_t* const xedd);
